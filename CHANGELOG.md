...
- - -
## Pre-cog history (commitizen)

The entries below were generated by [Commitizen](https://commitizen-tools.github.io/commitizen/) before the project switched to [Cocogitto](https://docs.cocogitto.io/) for release management. Future releases will be added above the `- - -` separator.
