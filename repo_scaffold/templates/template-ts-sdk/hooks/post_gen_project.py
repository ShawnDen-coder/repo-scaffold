"""Post-generation project setup and cleanup script for TypeScript SDK library projects."""
...
def main() -> None:
    ...
    print("🚀 Starting TypeScript SDK library project post-generation setup...")
