...
from repo_scaffold.cli import cli, create, list_templates, show_template, components as list_components
...
def test_list_components_command(mock_component_manager, cli_runner, temp_components_dir):
    ...
    mock_manager.components = {
        "python_core": mock_python_core,
        "cli_support": mock_cli_support
    }
...
def test_create_command_with_template(mock_load_config, mock_runner, mock_composer, mock_selection, cli_runner):
    ...
    mock_config = {
        ...
        "display_name": "Python Library",
        "optional_components": {
            "cli_support": {"prompt": "Add CLI?", "default": False}
        }
    }
    mock_load_config.return_value = mock_config
...
def test_create_command_interactive(mock_runner, mock_composer, mock_comp_selection, mock_temp_selection, cli_runner):
    ...
    mock_temp_selection.return_value = ("python-library", {
        "name": "python-library",
        "optional_components": {}
    })
